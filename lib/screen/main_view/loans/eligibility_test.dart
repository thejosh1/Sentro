            ...
            children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SvgPicture.asset(calculator, width: widthSize(24),
                          height: heightSize(24), colorFilter: useAccent?ColorFilter.mode(accent, BlendMode.srcIn):null,)
                      ],
                    ),
                  )
                ],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: useAccent?accent.withOpacity(0.1):sNavContainer.withOpacity(0.1),
                ),
                child: Center(
                  child: SvgPicture.asset(securityUser, width: widthSize(136),
                    height: heightSize(136), colorFilter: useAccent?ColorFilter.mode(accent, BlendMode.srcIn):null,),
                ),
              ),
              ...
              ActionButton(
                ...
                borderColor: useAccent?accent:sNavContainer,
