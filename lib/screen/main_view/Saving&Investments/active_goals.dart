...
class _ActiveGoalsState extends State<ActiveGoals>
  ...
  void initState() {
    ...
    _dollarProgressAnim =
        Tween<double>(begin: 0, end: _dollarCurrent / _dollarTarget).animate(
          CurvedAnimation(parent: _controller, curve: Curves.easeOutCubic),
        );
  ...
  Widget _cardHeader({
    ...
    return Row(
      children: [
        SvgPicture.asset(barChat, width: widthSize(38), height: heightSize(38), colorFilter: useAccent?ColorFilter.mode(accent, BlendMode.srcIn):null,),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: useAccent?accent.withOpacity(0.2):isDark ? statusColor.withOpacity(0.1) : statusColor
                .withOpacity(0.2),
          ),
          child: Center(
            child: CText(text: status,
                ...
                fontWeight: CFONT.wRegular,
                fontFamily: CFONT.FAMILY,
                color: useAccent?accent:isDark ? statusColor : sActionButton),
          ),
        ),
      ],
    );
    ...
    return Row(
      ...
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CText(text: 'Interest Rate',
                fontFamily: CFONT.FAMILY,
                fontWeight: CFONT.wRegular,
                size: 10,
                color: sGrey2),
            CText(text: interestRate,
                fontFamily: CFONT.FAMILY,
                fontWeight: CFONT.wMedium,
                size: 12,
                color: rateColor),
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            CText(text: 'Interest Paid',
                fontFamily: CFONT.FAMILY,
                fontWeight: CFONT.wRegular,
                size: 10,
                color: sGrey2),
            CText(text: interestPaid,
                fontFamily: CFONT.FAMILY,
                fontWeight: CFONT.wMedium,
                size: 12),
          ],
            ...
            Row(
              children: [
                ...
                if (reinvest) ...[
                  ...
                  SvgPicture.asset(
                      tick, width: widthSize(12), height: heightSize(12)),
                ],
              ],
            ),
          ],
          ...
          children: [
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                backgroundColor: useAccent?accent.withOpacity(0.1):sNavContainer.withOpacity(0.1),
                valueColor: AlwaysStoppedAnimation<Color>(useAccent?accent:sNavContainer),
              ),
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                CText(text: showPercent ? '$percent% complete' : leftLabel,
                    size: 11,
                    fontFamily: CFONT.FAMILY,
                    fontWeight: CFONT.wRegular,
                    color: sGrey2),
  ...
  Widget _cardShell(
      {required Widget child, required GoalModel goal, required bool isDark, bool? useAccent, Color? accent}) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () => Get.back(),
                    child: SvgPicture.asset(isDark ? arrowBackWhite : arrowBack,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          SvgPicture.asset(add, width: widthSize(24),
              ...
              CText(text: 'Active Goals',
                  fontFamily: CFONT.FAMILY,
                  size: 18,
                  fontWeight: CFONT.wMedium),
              SizedBox(height: heightSize(2.5)),
              CText(text: 'Monitor your savings progress',
                  fontFamily: CFONT.FAMILY,
                  size: 14,
                  fontWeight: CFONT.wRegular,
                  height: 20 / 14,
                  ...
                  children: [
                    ...
                    _cardShell(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _cardHeader(type: 'Target Savings',
                            name: 'Equipment Funds',
                            status: 'Active',
                            statusColor: sNavContainer,
                            isDark: isDark,
                            useAccent: useAccent,
                            accent: accent,
                          ),
                          ...
                          SizedBox(height: heightSize(2.5)),
                          CText(text: 'of N5,000,000 goal',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
                          SizedBox(height: heightSize(8.5)),
                          _progressSection(anim: _progressAnim,
                            leftLabel: '',
                          ...
                          _cardFooter(interestRate: '10% p.a',
                              interestPaid: 'Monthly',
                              reinvest: true),
                        ],
                      ),
                    ...
                    _cardShell(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _cardHeader(type: 'FGN TREASURY BILLS',
                            name: 'Q2 2026 T-Bills',
                            status: 'Active',
                            statusColor: sNavContainer,
                            isDark: isDark,
                          ...
                          CText(text: 'N3,500,000',
                              ...
                              fontWeight: CFONT.wBold),
                          SizedBox(height: heightSize(2.5)),
                          CText(text: 'CBN-backed · Zero risk',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
                          SizedBox(height: heightSize(8.5)),
                          _payoutBox(label: 'Next interest payout',
                              value: 'N578,125 on July 15',
                              color: sPurple),
                          SizedBox(height: heightSize(9)),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              CText(text: '91 days tenor',
                                  size: 11,
                                  fontFamily: CFONT.FAMILY,
                                  fontWeight: CFONT.wRegular,
                                  color: sGrey2),
                              CText(text: 'Matures 30 Jun, 2026',
                                  size: 11,
                                  fontFamily: CFONT.FAMILY,
                                  fontWeight: CFONT.wRegular,
                                  color: sGrey2),
                    ...
                    _cardShell(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _cardHeader(type: 'DOLLAR SAVINGS',
                            name: 'USD Savings Vault',
                            status: 'Active',
                            statusColor: sNavContainer,
                            isDark: isDark,
                          ...
                          SizedBox(height: heightSize(18)),
                          CText(text: 'N8,200.00',
                              size: 18,
                              fontFamily: CFONT.FAMILY,
                              fontWeight: CFONT.wBold),
                          SizedBox(height: heightSize(2.5)),
                          CText(text: '~ N12,382,000 at current rate (N135)',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
                          ...
                          Divider(color: sDarkBorder),
                          SizedBox(height: heightSize(10)),
                          _cardFooter(interestRate: '5.7% p.a',
                              interestPaid: 'Monthly',
                              reinvest: false),
                        ],
                      ),
                    ...
                    _cardShell(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _cardHeader(type: 'FIXED DEPOSIT',
                            name: 'New Car Lock',
                            status: 'Locked',
                            statusColor: sNavContainer,
                            isDark: isDark,
                          ...
                          CText(text: 'N3,500,000',
                              ...
                              fontWeight: CFONT.wBold),
                          SizedBox(height: heightSize(2.5)),
                          CText(text: 'Locked until 30 Jun, 2026',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
                          SizedBox(height: heightSize(8.5)),
                          _payoutBox(label: 'Projected total at maturity',
                              value: 'N578,125 on July 15',
                              color: sLightBlue),
                          SizedBox(height: heightSize(9)),
                          Row(
                    ...
                    _cardShell(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _cardHeader(type: 'FLEXIBLE SAVINGS',
                            name: 'Business Vault',
                            status: 'Active',
                            statusColor: sNavContainer,
                            isDark: isDark,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CText(text: 'N3,500,000',
                              ...
                              fontWeight: CFONT.wBold),
                          SizedBox(height: heightSize(2.5)),
                          CText(text: '+ ₦246,700 interest earned',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
                          SizedBox(height: heightSize(8.5)),
                          _payoutBox(label: 'Portfolio value today',
                              value: 'N578,125,000',
                              color: sLilac),
                          SizedBox(height: heightSize(9)),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              CText(text: 'Open-ended',
                                  size: 11,
                                  fontFamily: CFONT.FAMILY,
                                  fontWeight: CFONT.wRegular,
                                  color: sGrey2),
                              CText(text: 'Withdraw anytime',
                                  size: 11,
                                  fontFamily: CFONT.FAMILY,
                                  fontWeight: CFONT.wRegular,
                                  color: sGrey2),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CText(text: 'N3,500,000',
                              ...
                              fontWeight: CFONT.wBold),
                          SizedBox(height: heightSize(2.5)),
                          CText(text: 'No lock-in · Withdraw anytime',
                              size: 11,
                              fontWeight: CFONT.wRegular,
                              fontFamily: CFONT.FAMILY,
                              color: isDark ? sGrey1 : sGrey2),
